        ...
        <form method="POST" action="{{ route('owner.escorts.update', $escort) }}" class="grid gap-8 lg:grid-cols-[1fr_360px]">
            ...
            <div class="space-y-6">
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <label class="md:col-span-2">
                            ...
                            <input name="title" value="{{ old('title', $escort->title) }}" required placeholder="Dohna" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950 placeholder:text-ink-950/35">
                ...
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        <label>
                            ...
                            <input name="age" type="number" min="18" value="{{ old('age', $escort->age) }}" required class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                        ...
                        <label>
                            ...
                            <input name="gender" value="{{ old('gender', $escort->gender) }}" required class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                        ...
                        <label>
                            ...
                            <input name="nationality" value="{{ old('nationality', $escort->nationality) }}" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        <label>
                            ...
                            <input name="height" value="{{ old('height', $escort->height) }}" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                        ...
                        <label>
                            ...
                            <input name="weight" value="{{ old('weight', $escort->weight) }}" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                        ...
                        <label>
                            ...
                            <input name="hair_color" value="{{ old('hair_color', $escort->hair_color) }}" placeholder="Brunette" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        <label>
                            ...
                            <input name="build" value="{{ old('build', $escort->build) }}" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                        ...
                        <label>
                            ...
                            <input name="smoker" value="{{ old('smoker', $escort->smoker) }}" placeholder="No" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                        ...
                        <label>
                            ...
                            <input name="sexual_orientation" value="{{ old('sexual_orientation', $escort->sexual_orientation) }}" placeholder="Bisexual" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                ...
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <label>
                            ...
                            <input name="availability" value="{{ old('availability', $escort->availability) }}" placeholder="Incall, Outcall" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                        ...
                        <label>
                            ...
                            <input name="whatsapp_number" value="{{ old('whatsapp_number', $escort->whatsapp_number) }}" required placeholder="256700000000" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950">
                ...
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    ...
                    <div class="grid gap-5">
                        <label class="block">
                            ...
                            <textarea name="rates_text" rows="4" placeholder="30 minutes: 100 EUR\n1 hour: 180 EUR" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950 placeholder:text-ink-950/35">{{ $ratesText }}</textarea>
                        ...
                        <label class="block">
                            ...
                            <textarea name="languages_text" rows="4" placeholder="English: Fluent\nFrench: Conversational" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950 placeholder:text-ink-950/35">{{ $languagesText }}</textarea>
                ...
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    ...
                    <label class="block">
                        ...
                        <textarea name="services_text" rows="5" placeholder="GFE\n69\nFoot fetish" class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm text-ink-950 placeholder:text-ink-950/35">{{ old('services_text', implode("\n", $escort->services_offered ?: [])) }}</textarea>
                ...
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    ...
                    <label class="block">
                        ...
                        <textarea name="description" rows="8" required class="w-full rounded-xl border border-gold-400/20 bg-ivory-50 px-4 py-3 text-sm leading-7 text-ink-950 placeholder:text-ink-950/35">{{ old('description', $escort->description) }}</textarea>
            ...
            <aside class="h-fit rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 lg:sticky lg:top-28">
                ...
                <div class="my-5 space-y-3 border-y border-gold-400/20 py-5 text-sm text-ebony-900/70">
                    ...
                    <div class="flex justify-between gap-4"><span>Profile</span><span class="font-bold text-ink-950">{{ $escort->title }}</span></div>
                    <div class="flex justify-between gap-4"><span>Location</span><span class="font-bold text-ink-950">{{ $escort->neighborhood }}</span></div>
                </div>
