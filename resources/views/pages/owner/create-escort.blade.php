<x-layouts.app title="Create service listing - HoneyBee Escorts">
    <section class="px-5 py-10 lg:px-10">
        <div class="mb-8 max-w-3xl">
            ...
            <p class="mt-4 text-sm leading-7 text-ivory-50/60">Share your appearance, special offers, rates, and contact details so clients can book you confidently.</p>
        </div>
        ...
        <form method="POST" action="{{ route('owner.escorts.store') }}" class="grid gap-8 lg:grid-cols-[1fr_360px]">
            ...
            <div class="space-y-6">
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-ivory-50/55">Set the name, category and style of service you want to be discovered for.</p>
                    </div>

                    <div class="grid gap-5 md:grid-cols-2">
                        <label class="md:col-span-2">
                            <span class="mb-2 block text-xs font-extrabold uppercase tracking-wide text-gold-400">Profile name</span>
                            <input name="title" value="{{ old('title') }}" required placeholder="Dohna" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50 placeholder:text-ivory-50/35">
                ...
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-ivory-50/55">Clients browse by physical details and comfort preferences.</p>
                    </div>

                    <div class="grid gap-5 md:grid-cols-3">
                        <label>
                            <span class="mb-2 block text-xs font-extrabold uppercase tracking-wide text-gold-400">Age</span>
                            <input name="age" type="number" min="18" value="{{ old('age') }}" required class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                        ...
                        <label>
                            ...
                            <input name="gender" value="{{ old('gender') }}" required class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                        ...
                        <label>
                            ...
                            <input name="nationality" value="{{ old('nationality') }}" placeholder="Ugandan" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        <label>
                            ...
                            <input name="height" value="{{ old('height') }}" placeholder="170 cm" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                        ...
                        <label>
                            ...
                            <input name="weight" value="{{ old('weight') }}" placeholder="55 kg" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                        ...
                        <label>
                            ...
                            <input name="bust_size" value="{{ old('bust_size') }}" placeholder="34C / Slim" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                    ...
                    <div class="grid gap-5 md:grid-cols-3">
                        <label>
                            ...
                            <input name="hair_color" value="{{ old('hair_color') }}" placeholder="Brunette" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                        ...
                        <label>
                            ...
                            <input name="hair_length" value="{{ old('hair_length') }}" placeholder="Long" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                        ...
                        <label>
                            ...
                            <input name="build" value="{{ old('build') }}" placeholder="Athletic" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                ...
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-ivory-50/55">How clients can reach you and when you are available.</p>
                    </div>
                    <div class="grid gap-5 md:grid-cols-2">
                        <label>
                            <span class="mb-2 block text-xs font-extrabold uppercase tracking-wide text-gold-400">Availability</span>
                            <input name="availability" value="{{ old('availability', 'Incall, Outcall') }}" placeholder="Incall, Outcall" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                        ...
                        <label>
                            ...
                            <input name="whatsapp_number" value="{{ old('whatsapp_number') }}" required placeholder="256700000000" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50 placeholder:text-ivory-50/35">
                    ...
                    <label class="block">
                        ...
                        <input name="phone" value="{{ old('phone') }}" placeholder="Optional" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50">
                ...
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-ivory-50/55">List your top services and packages, one per line.</p>
                    </div>
                    <label class="block">
                        <span class="mb-2 block text-xs font-extrabold uppercase tracking-wide text-gold-400">Services</span>
                        <textarea name="services_text" rows="5" placeholder="GFE\n69\nMassage" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50 placeholder:text-ivory-50/35">{{ old('services_text') }}</textarea>
                ...
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <label class="block">
                            ...
                            <textarea name="rates_text" rows="5" placeholder="30 minutes: 100 EUR\n1 hour: 180 EUR" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50 placeholder:text-ivory-50/35">{{ old('rates_text') }}</textarea>
                        ...
                        <label class="block">
                            ...
                            <textarea name="languages_text" rows="5" placeholder="English: Fluent\nFrench: Conversational" class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm text-ivory-50 placeholder:text-ivory-50/35">{{ old('languages_text') }}</textarea>
                ...
                <section class="rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 md:p-7">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-ivory-50/55">Write a polished introduction that helps clients understand your experience and vibe.</p>
                    </div>
                    <label class="block">
                        <span class="mb-2 block text-xs font-extrabold uppercase tracking-wide text-gold-400">Profile description</span>
                        <textarea name="description" rows="8" required placeholder="Introduce yourself, your preferred appointments, and what makes the experience special." class="w-full rounded-xl border border-gold-400/20 bg-ink-950/60 px-4 py-3 text-sm leading-7 text-ivory-50 placeholder:text-ivory-50/35">{{ old('description') }}</textarea>
            ...
            <aside class="h-fit rounded-2xl border border-gold-400/20 bg-ebony-850 p-5 lg:sticky lg:top-28">
                ...
                <p class="mt-2 text-sm leading-6 text-ivory-50/60">Your profile will be visible to booking clients after you publish.</p>
                <div class="my-5 space-y-3 border-y border-gold-400/20 py-5 text-sm text-ivory-50/65">
                    ...
                    <div class="flex justify-between gap-4"><span>Contact channel</span><span class="font-bold text-ivory-50">WhatsApp</span></div>
                    <div class="flex justify-between gap-4"><span>Brought by</span><span class="font-bold text-ivory-50">{{ auth()->user()->name }}</span></div>
                </div>
